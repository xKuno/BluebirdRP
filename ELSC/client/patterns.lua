				...
				if stage == 1 then
					Citizen.CreateThread(function()
						for spot = 1, string.len(chp_StageOne[pattern][1]) do
							...
							if elsVehs[k] ~= nil and elsVehs[k].advisorPattern ~= pattern then
								done[1] = true
								break
							end
				...
				elseif stage == 2 then
					Citizen.CreateThread(function()
						for spot = 1, string.len(chp_StageTwo[pattern][1]) do
							...
							if elsVehs[k] ~= nil and elsVehs[k].secPattern ~= pattern then
								done[1] = true
								break
							end
				...
				elseif stage == 3 then
					...
					Citizen.CreateThread(function()
						for spot = 1, string.len(chp_StageThree[pattern][2]) do
							...
							if elsVehs[k] ~= nil and elsVehs[k].primPattern ~= pattern then
								done[2] = true
								break
							end
		...
		if (not IsEntityDead(k) and DoesEntityExist(k) and (ledWarningReady[k] or ledWarningReady[k] == nil)) then
			...
			Citizen.CreateThread(function()
				for spot = 1, string.len(leds_WarningPatterns[pattern][5]) do
					...
					if elsVehs[k] ~= nil and elsVehs[k].advisorPattern ~= nil and elsVehs[k].advisorPattern ~= pattern then
						done[1] = true
						break
					end
		...
		if (not IsEntityDead(k) and DoesEntityExist(k) and (ledPrimaryReady[k] or ledPrimaryReady[k] == nil)) then
			...
			Citizen.CreateThread(function()
				for spot = 1, string.len(led_PrimaryPatterns[pattern][1]) do
					...
					if elsVehs[k] ~= nil and elsVehs[k].primPattern ~= nil and elsVehs[k].primPattern ~= pattern then
						done[1] = true
						break
					end
