...
EnableInteriorProp(int_id , "DJ_01_Lights_04")

EnableInteriorProp(int_id , "DJ_02_Lights_01")
EnableInteriorProp(int_id , "DJ_02_Lights_02")
EnableInteriorProp(int_id , "DJ_02_Lights_03")
EnableInteriorProp(int_id , "DJ_02_Lights_04")

EnableInteriorProp(int_id , "DJ_03_Lights_01")
EnableInteriorProp(int_id , "DJ_03_Lights_02")
EnableInteriorProp(int_id , "DJ_03_Lights_03")
EnableInteriorProp(int_id , "DJ_03_Lights_04")

EnableInteriorProp(int_id , "DJ_04_Lights_01")
EnableInteriorProp(int_id , "DJ_04_Lights_02")
EnableInteriorProp(int_id , "DJ_04_Lights_03")
...
EnableInteriorProp(int_id , "Int01_ba_deliverytruck")
...
EnableInteriorProp(int_id , "Int01_ba_Worklamps") -- работа
