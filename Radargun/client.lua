...
Citizen.CreateThread(function()
	while(true) do
		...
		getSelectedWeapon = GetSelectedPedWeapon(isPed) == cfg.radargun
		...
		if shown then
			if getSelectedWeapon then
				if isFreeAiming then
					...
					coordB = GetOffsetFromEntityInWorldCoords(player, 0.0, 250.0, 0.0)
...
Citizen.CreateThread( function()
	while true do
		...
		-- ////////////////////////////////////////////////////////////////
			...
			if IsControlJustPressed(1, cfg.menuopen) and GetLastInputMethod(1) then --246 = Y
