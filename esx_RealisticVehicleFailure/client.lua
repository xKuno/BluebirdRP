...
RegisterNetEvent('558b24fa-abf8-4e96-af7a-8ccb56dbbda7')
AddEventHandler('558b24fa-abf8-4e96-af7a-8ccb56dbbda7', function()
					...
					if mechNumb == 1 then
						...
						if GetIsVehicleEngineRunning(vehicle) then
							...
							if cfg.chargeForRepairs then
								TriggerServerEvent('614c4470-33b9-4ed7-b74a-121c8b2f5deb', repairCost)
...
RegisterNetEvent('7c5fe455-6d2b-4924-9209-943c67147a7a')
AddEventHandler('7c5fe455-6d2b-4924-9209-943c67147a7a', function()
	...
	while true do
		...
		if isPedDrivingAVehicle() then
			...
			if healthEngineCurrent > cfg.engineSafeGuard+1 then
				SetVehicleUndriveable(vehicle,false)
				TriggerEvent('f97ad559-7b81-49f8-aae8-bda8ec87029f',true)
			end

			if healthEngineCurrent <= cfg.engineSafeGuard+1 and cfg.limpMode == false then
				SetVehicleUndriveable(vehicle,true)
				TriggerEvent('f97ad559-7b81-49f8-aae8-bda8ec87029f',false)
			end
			...
			if pedInSameVehicleLast == true then
				...
				if cfg.deformationMultiplier ~= -1 and vehicleClass ~= 18 then SetVehicleHandlingFloat(vehicle, 'CHandlingData', 'fDeformationDamageMult', newFDeformationDamageMult * cfg.deformationMultiplier) end  -- Multiply by our factor
...
AddEventHandler(  'wk:fixVehicle', function() 
	print('fix received on clientside')
	local ped = GetPlayerPed( -1 )
