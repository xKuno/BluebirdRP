Locales['en'] = {
  ...
  ['helicopter_notauthorized'] = 'you\'re not authorized to use helicopters.',
  ['garage_prompt'] = 'press ~INPUT_CONTEXT~ to access the ~y~Vehicle Actions~s~.',
  ['distress_view'] = 'press ~y~[H]~w~ to view your ~o~injuries.~s~',
  ...
  ['garage_buyitem'] = 'vehicle garage',
  ['shop_item'] = '$%s',
  ['vehicleshop_title'] = 'vehicle garage',
  ['vehicleshop_confirm'] = 'do you want to select this vehicle?',
  ...
  -- Phone
  ['alert_ambulance'] = 'alert Ambulance/CFA',
  -- Death
  ['respawn_available_in'] = 'respawn available in ~b~%s minutes %s seconds~s~',
  ['respawn_bleedout_in'] = 'you are unconscious and may/may not die in ~b~%s minutes %s seconds~s~\n',
  ...
  ['distress_send'] = 'press [~b~G~s~] to call an Ambulance via 000',
  ['distress_sent'] = 'You have placed your 000 call. An ambulance shouldnt be too far off!',
  ['distress_message'] = '000: medical attention required: unconscious person!',
  ['combatlog_message'] = 'You\'ve previously left the server when dead. You will remain dead till the timer expires',
  -- Revive
