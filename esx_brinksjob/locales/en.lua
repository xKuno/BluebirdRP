Locales['en'] = {
	['cloakroom']				= 'Muster Room',
	['job_wear']				= 'Start Shift',
	['citizen_wear']			= 'End Shift',
	...
	['blip_job']				= 'Armaguard', --'Garbage company',
	['blip_delivery']			= 'Armaguard : Pickup Location', --'Garbage company : Delivery',
	['blip_goal']				= 'Armaguard : Money Pickup', --'Garbage company : Delivery point',
	['blip_depot']				= 'Armaguard : depot', --'Garbage company : depot',
