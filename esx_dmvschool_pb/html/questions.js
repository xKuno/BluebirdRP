var tableauQuestion = [
    {   question : "If you're going 65 kmh, and you're approaching a residential area you must:",
    ...
    {   question : "Without any prior indication, the speed in a residential area is: __ kmh",
        propositionA : "30",
        propositionB : "45",
        propositionC : "50",
        propositionD : "80",
  ...
  {   question : "When can you continue to drive at a traffic light?",
        ...
        propositionD : "When there is a red light",
        reponse : "A"},

  {   question : "A pedestrian has a do not cross signal, what do you do?",
        propositionA : "You let them pass",
        propositionB : "You stop your car and observe before continuing",
        propositionC : "You wave to tell them to cross and wave frantically",
  ...
  {   question : "You are driving on a highway which indicates a maximum speed of 100 kmh. Most traffic drives at 110 kmh, so you should not drive faster than:",
        propositionA : "50 kmh",
        propositionB : "80 kmh",
  ...
  {   question : "When you are overtaken by another vehicle it is important NOT to:",
        ...
        reponse : "D"},
{   question : "If I commit a Hoon offence I can expect to:",
        propositionA : "Receive an infringement Notice",
        propositionB : "Have my vehicle impounded by Police",
        propositionC : "Walk Home",
        propositionD : "All of the above",
        reponse : "D"},
{   question : "If an emergency vehicle is stationary, with its lights flashing you must:",
        propositionA : "Speed up to get out of their way",
        propositionB : "Stop in the middle of the road",
        propositionC : "Give up driving",
        propositionD : "Carefully reduce speed to 40km/h until you have safely passed (per the road rules)",
        reponse : "D"},		
