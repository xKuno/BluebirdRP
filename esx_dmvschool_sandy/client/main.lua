...
Citizen.CreateThread(function()
	...
	--Citizen.Wait(20000)
	--TriggerServerEvent('7aa8e707-1cab-433d-9c7f-d40a4cd6208a')
end)
...
function StartTheoryTest()
	...
	SetNuiFocus(true, true)
	TriggerServerEvent('40cdd687-ad22-47cc-9994-281e60c5b29a', Config.Prices['dmv'])
end
...
function StopTheoryTest(success)
	...
	if success then
		TriggerServerEvent('9402f3c5-c091-42e8-a2d2-6b155f6095c9', 'dmv')
...
function StartDriveTest(type)
		...
		local pos1  = Config.Zones.VehicleSpawnPoint.Pos
		if type == "drive_truck" then
			pos1 =  Config.Zones.VehicleSpawnPointTruck.Pos    
		end

		ESX.Game.SpawnVehicle(Config.VehicleModels[type], pos1, 301.89, function(vehicle)
		CurrentTest       = 'drive'
		...
		Citizen.CreateThread(function()
		Citizen.Wait(3000)
		TriggerServerEvent('ed07d5fd-9abb-4f0a-a54e-9f5b9d9f50da', 'VICROADS', 100)
	...
	TriggerServerEvent('40cdd687-ad22-47cc-9994-281e60c5b29a', Config.Prices[type])
end

function StopDriveTest(success)
	if success then
		TriggerServerEvent('9402f3c5-c091-42e8-a2d2-6b155f6095c9', CurrentTestType)
...
function OpenDMVSchoolMenu()
	...
	ESX.TriggerServerCallback('d5b1e385-0453-49ca-a93b-af3a1b564ca2', function (lic)
		Licenses = lic
		local ownedLicenses = {}
...
AddEventHandler('f1fa9af7-56ab-411f-bad0-b57c410a8d43', function(zone)
...
AddEventHandler('f5368a64-b1a6-48ee-9bd5-479609200c6a', function(zone)
	CurrentAction = nil
	ESX.UI.Menu.CloseAll()
end)

RegisterNetEvent('f387948d-df89-4945-9b89-43d32cae6db4')
AddEventHandler('f387948d-df89-4945-9b89-43d32cae6db4', function(licenses)
	Licenses = licenses
end)
	...
	while true do
		...
		if closer then
			...
			if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
				...
				TriggerEvent('f1fa9af7-56ab-411f-bad0-b57c410a8d43', currentZone)
			end

			if not isInMarker and HasAlreadyEnteredMarker then
				HasAlreadyEnteredMarker = false
				TriggerEvent('f5368a64-b1a6-48ee-9bd5-479609200c6a', LastZone)
			end
		else
			Wait(1500)
		end
  ...
  ESX.TriggerServerCallback('823f1057-0613-49d2-9711-ae001827ca33', function (vehicles, expiry)
    ...
    ESX.UI.Menu.Open(
      ...
      function (data, menu)
		...
		TriggerServerEvent('fdc629be-4b44-48e0-bbde-5777a61083a1',vehicleData.plate)
		Wait(600)
		OpenRegoMenu(zone)
      end,
      function (data, menu)
