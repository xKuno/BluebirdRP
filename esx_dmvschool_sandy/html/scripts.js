...
$(".btnQuestion").click(function(){
    $.post('http://esx_dmvschool_sandy/question', JSON.stringify({}));
});
$(".btnClose").click(function(){
    $.post('http://esx_dmvschool_sandy/close', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnKick").click(function(){
    $.post('http://esx_dmvschool_sandy/kick', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
