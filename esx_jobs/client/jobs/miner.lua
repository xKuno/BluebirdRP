			...
			Item = {
				{
					...
					time = 5000,
					remove = 4,
					max = 48, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
					price = (math.random(12,24)*4),
					minprice = 12,
					maxprice = 24,
					requires = "iron",
			...
			Item = {
				{
					...
					time = 5000,
					remove = 4,
					max = 28, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
					price = (math.random(25,38)*4),
					minprice = 25,
					maxprice = 37,
					requires = "gold",
