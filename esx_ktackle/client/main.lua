...
RegisterNetEvent('3a19ad97-0513-4976-9bd6-9f136fc09c1d')
AddEventHandler('3a19ad97-0513-4976-9bd6-9f136fc09c1d', function(target)
...
RegisterNetEvent('02119a47-4f6f-4f6f-8875-e277db54692a')
AddEventHandler('02119a47-4f6f-4f6f-8875-e277db54692a', function()
	local playerPed = GetPlayerPed(-1)
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlPressed(0, Keys['LEFTSHIFT']) and IsControlPressed(0, Keys['G']) and not isTackling and GetGameTimer() - lastTackleTime > 10 * 1000 and (PlayerData.job.name == PoliceJob or PlayerData.job.name == PoliceJob2 ) then
			Citizen.Wait(10)
			...
			if distance ~= -1 and distance <= Config.TackleDistance and not isTackling and not isGettingTackled and not IsPedInAnyVehicle(GetPlayerPed(-1)) and not IsPedInAnyVehicle(GetPlayerPed(closestPlayer)) then
				...
				TriggerServerEvent('663d093e-7704-4792-bd25-b6f43b1b6fd5', GetPlayerServerId(closestPlayer))
			end
		end
	end
end)