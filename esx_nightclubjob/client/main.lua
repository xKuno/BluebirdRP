...
function OpenCloakroomMenu()
  ...
  local playerPed = GetPlayerPed(-1)
   ...
   TriggerEvent(   'esx_jb_dj:enabledjbooth', true,"nightclubgalaxy")
    ...
    ESX.TriggerServerCallback('8def0e18-67f6-4500-a5e2-6e16aee4eb00', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('293760c8-b5e2-4800-bc04-944c4b572970', 'nightclub', vehicleProps)
      ...
      if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
              ...
              function(data2, menu2)
                ...
                TriggerServerEvent('441f9e00-d3f1-4fca-bc21-bf0ac493e705', data2.current.value)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('c9ac0436-8b83-467d-abe5-4978cdf78f9b', GetPlayerServerId(player), 'society_nightclub', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('1aa87713-f1d6-4d20-bf19-dfd3eb0e7416', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('63f5bd7a-3068-41b3-aa49-4c23a668e7b9', itemName, count)
            end
...
ESX.TriggerServerCallback('0cca6aa3-06a4-4ba4-a78d-a9e14ef6f819', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('09c9d155-c56c-44fd-8fa1-6db3a38932a7', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('b4f3e0fa-d246-4b9d-ad67-5260c15237c3', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('a75131d1-1f8c-48bd-8e0c-9190e394b67d', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('5ec86e1c-a263-44f7-ad74-e0f8a582af8c', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('92f756ba-b182-4930-9997-c1cd31930dd1', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('72e6a685-0a1d-4a05-9c15-1b0f64b76a93', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('a4a52ffe-dce0-453f-9109-85ccd5291469', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
--Flacons
    ...
    ESX.UI.Menu.Open(
        ...
        function(data, menu)
            TriggerServerEvent('ad8045d8-7c05-41d3-8509-d33ac07419b5', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('40b77c16-08b9-43bb-9e1b-ec951b854cc8', function(zone)
...
AddEventHandler('1ccfaa20-a96c-4f58-868d-94570075440c', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('40b77c16-08b9-43bb-9e1b-ec951b854cc8', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('1ccfaa20-a96c-4f58-868d-94570075440c', LastZone)
            end
		else
			Wait(10000)
		  ...
		  if IsControlJustReleased(0,  Keys['E']) then
			...
			if CurrentAction == 'delete_vehicle' then
			  ...
			  if Config.EnableSocietyOwnedVehicles then
				...
				TriggerServerEvent('ee25e8b0-b555-4cd2-b500-24c1cbd32f88', 'nightclub', vehicleProps)
				...
				then
				  TriggerServerEvent('a91f16e6-8b39-4118-b7d3-68f32f337985', 'nightclub')
				end
			...
			if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
			  ...
			  TriggerEvent('9878e951-0ff0-4996-be7e-f0eb7c427247', 'nightclub', function(data, menu)
...
AddEventHandler('c342bae1-4b63-41d5-9df4-96e3926e98b2', function(position)
  ...
  while true do
	...
	if IsJobTrue() then
        ...
        if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
          TriggerEvent('c342bae1-4b63-41d5-9df4-96e3926e98b2', position)
        end
