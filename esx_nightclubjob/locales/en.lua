Locales['en'] = {
    ...
    ['unicorn_fridge_stock']     = 'Fridge of the Galaxy Nightclub',
    ['fridge_inventory']         = 'Content of the fridge',
  
    -- Shops  
    ['shop']                     = 'Galaxy Nightclub Shop',
    ...
    ['quantity']                 = 'Amount',
    ['inventory']                = 'Inventory',
    ['unicorn_stock']            = 'Stock of Galaxy Nightclub',
    ...
    -- Misc  
    ['map_blip']                 = 'Galaxy Nightclub',
    ['unicorn']                  = 'Galaxy Nightclub',
  
    -- Phone  
    ['unicorn_phone']            = 'Galaxy',
