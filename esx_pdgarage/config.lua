...
Config.PoliceDatabaseName2 = 'ambulance'
...
Config.CarZones = {
	PoliceCarGarage = {
		Pos = {
			...
			--vector3(-466.36877441406,6033.68359375,31.340538024902 )
...
Config.HeliZones = {
	PoliceHeliGarage = {
		Pos = {
			vector3(579.81, 11.23, 103.23),
			vector3(1770.47, 3239.62, 42.18),
			vector3(-475.35, 5989.07, 31.34),
			vector3(449.496,-981.518,43.691),
			vector3(481.573,-982.521,41.0080)
...
Config.PoliceVehicles = {
	{ model = 'police', label = 'Divisional Van - Police', price = 0 },
...
Config.PoliceHelicopters = {
	{ model = 'polmav', label = 'Police Dauphin', livery = 0, price = 0 },
	{ model = 'polaw139', label = 'Police AW139', livery = 0, price = 0 },
	{ model = 'supervolito', label = 'Police EuroCopter', livery = 0, price = 0 },
	{ model = 'swift', label = 'Ambo Chopper Swift', livery = 0, price = 0 },
	{ model = 'aw139', label = 'Ambo Chopper AW139', livery = 0, price = 0 },
}
...
Config.ExtraZones = {
	ExtraPositions = {
		Pos = {
			...
			vector3(461.70077514648,-1014.7628173828,28.070734024048 ), -- Melbourne 2
			vector3(-469.17776489258,6038.7758789063,31.340539932251 ), -- Paleto
			vector3(1870.9989013672,3699.5734863281,33.41393661499 ),  --Mt Thomas
			vector3(581.17584228516,38.874027252197,92.631227111816 ), --Vinewood
			vector3(-1064.5400390625,-855.91876220703,4.8677048683167 ), --Vespucci
			vector3(-1638.0056152344,-1008.2370605469,13.090279579163 ), -- Pier
			vector3(385.20736694336,-1613.7434082031,29.292057037354 ) --Sheriff 900
		}
	}
}
