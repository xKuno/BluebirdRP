...
Config.Zones = {
  ...
  PilotActions = {
        Pos   = {x = -1616.00, y = -3144.50, z = 13.00},
        Size  = {x = 1.5, y = 1.5, z = 1.0},
        Color = {r = 0, g = 255, b = 0},
        Type  = 1
    },
	BoatActions = {
        Pos   = {x = -753.916, y = -1506.210, z = 4.2},
        Size  = {x = 1.5, y = 1.5, z = 1.0},
        Color = {r = 0, g = 255, b = 0},
        Type  = 1
    },
	...
	Craft = {
		Pos   = { x = -323.140, y = -129.882, z = -137.999 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
        Pos   = {x = -1649.94, y = -3138.86, z = 13.99},
        Size  = {x = 1.5, y = 1.5, z = 1.0},
        Type  = -1
    },
	BoatSpawnPoint = {
        Pos   = {x = -826.341, y = -1511.602, z = 0.524},
        Size  = {x = 1.5, y = 1.5, z = 1.0},
        Type  = -1
    }, 

	VehicleDeleter = {
        Pos   = {x = -1660.40, y = -3156.97, z = 13.00},
	...
	VehicleDelivery = {
		Pos   = { x = -382.925, y = -133.748, z = -137.685 },
