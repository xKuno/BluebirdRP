		...
		function(data, menu)
			...
			if data.current.value == 'job_wear' then
				...
				ESX.TriggerServerCallback('4568d939-3661-4833-ae6a-378432ac6ff1', function(skin)
					...
					if skin.sex == 0 or 1 then
					local model = GetHashKey("s_m_y_delivery_01")
...
AddEventHandler('cc4d28b5-a8e3-40c3-b7ac-b1f9d5012730', function(zone)
...
AddEventHandler('a6434610-868a-4388-98f3-1c9559cd7849', function(zone)
	ESX.UI.Menu.CloseAll()    
    CurrentAction = nil
    CurrentActionMsg = ''
end)
...
function donnerlapaye()
	...
	if vievehicule >= 1 then
		if livraisonTotalPaye == 0 then
			...
			TriggerServerEvent('1f09b076-2c1d-46d3-a756-d416bbf401ab', amount)
	...
	while true do
		...
		if IsJobpizza() then
			...
			if isInMarker and not hasAlreadyEnteredMarker then
				...
				TriggerEvent('cc4d28b5-a8e3-40c3-b7ac-b1f9d5012730', currentZone)
			end

			if not isInMarker and hasAlreadyEnteredMarker then
				hasAlreadyEnteredMarker = false
				TriggerEvent('a6434610-868a-4388-98f3-1c9559cd7849', lastZone)
			end
			Wait(500)
		else
			Wait(5000)
