Locales['en'] = {
  ...
  ['traffic_offense_speed'] = 'Traffic - Speeding',
  ['traffic_offense_signslights'] = 'Traffic - Signs, Lights',
  ['traffic_offense_operation'] = 'Traffic - Operation',
    ['traffic_offense_lic'] = 'Traffic - Licence',
  ['traffic_offense_other'] = 'Traffic - Other',
  ['average_offense'] = 'Summary Offences',
  ['major_offense'] = 'Inditable Offences',
  ['fine_total'] = 'fine: ',
  -- Vehicle Info Menu
  ['plate'] = 'plate: %s',
