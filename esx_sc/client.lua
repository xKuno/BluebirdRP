...
RegisterNetEvent('9a7c2e1f-0392-49f5-8431-4c360eab836b')
AddEventHandler('9a7c2e1f-0392-49f5-8431-4c360eab836b', function(rewards,stayClosed) MFSC:StartMinigame(rewards,stayClosed); end)
...
function MFSC:EndMinigame(won, rewards)
    ...
    if not self.StayClosed then
		...
		TriggerServerEvent('8d8c80c1-e3b9-4b2d-885d-ee031dc00d74', rewards)
		
	else	
		PlaySoundFrontend(self.SoundID, self.Config.SafeResetSound, self.Config.SafeSoundset, true)
		msg = "~r~You couldn't open the lock."
	end

	TriggerEvent('2c4f07a6-bf05-4b02-ba86-fd4472391cbd', msg)
  TriggerEvent('3a6a5d8b-7917-4deb-a422-f55d08cc564c', won)
end

RegisterNetEvent('5148fbe7-296b-48d8-8b02-5d8592b0edde')
AddEventHandler('5148fbe7-296b-48d8-8b02-5d8592b0edde', function() MFSC:EndMinigame(); end)
...
function MFSC:Awake(...)
    ...
    ESX.TriggerServerCallback('707099c0-f2d3-450d-ae7b-73018e237ea3', function(retVal) self.dS = true; self.cS = retVal; self:Start(); end)
end
...
RegisterNetEvent('03f2a975-82d2-412b-8066-433878472a65')
AddEventHandler('03f2a975-82d2-412b-8066-433878472a65', function(tab, pos, heading, cb) if cb then cb(MFSC:SpawnSafeObject(tab,pos,heading)) else MFSC:SpawnSafeObject(tab,pos,heading); end; end)
