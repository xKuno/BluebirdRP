...
function OpenBossMenu(society, close, options)
	...
	ESX.TriggerServerCallback('3a66a873-bbad-42dc-9a88-aa2c7a1aaea0', function(result)
		isBoss = result
	end, society)
		...
		if data.current.value == 'withdraw_society_money' then
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'withdraw_society_money_amount_' .. society, {
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('b380f4e8-cfb3-42bf-b454-9e3f16ef54dc', society, amount)
				end
		...
		elseif data.current.value == 'deposit_money' then
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'deposit_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('d98e3469-8736-42bd-b0b0-4b79dcadbd25', society, amount)
				end
		...
		elseif data.current.value == 'wash_money' then
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'wash_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('35d9d5ae-ba6f-4672-a8d4-65937520560d', society, amount)
				end
...
function OpenEmployeeList(society)
	...
	ESX.TriggerServerCallback('ff498325-c6ad-4f50-976c-1766628bef0f', function(employees)
		...
		ESX.UI.Menu.Open('list', GetCurrentResourceName(), 'employee_list_' .. society, elements, function(data, menu)
			...
			if data.value == 'fire' then
				...
				TriggerEvent('2c4f07a6-bf05-4b02-ba86-fd4472391cbd', _U('you_have_fired', employee.name))

				ESX.TriggerServerCallback('39fa2d38-8a28-42dd-b36e-375552f17228', function()
					OpenEmployeeList(society)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_' .. society,
		{
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_confirm_' .. society,
			{
				...
				if data2.current.value == 'yes' then
					...
					TriggerEvent('2c4f07a6-bf05-4b02-ba86-fd4472391cbd', _U('you_have_hired', data.current.name))
...
function OpenPromoteMenu(society, employee)
	...
	ESX.TriggerServerCallback('b8e7c38d-e5bf-4ed3-866c-2b9ad71ccea1', function(job)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'promote_employee_' .. society,
		{
			...
			TriggerEvent('2c4f07a6-bf05-4b02-ba86-fd4472391cbd', _U('you_have_promoted', employee.name, data.current.label))
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_grades_' .. society,
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'manage_grades_amount_' .. society,
			{
				...
				elseif amount > Config.MaxSalary then
					...
					ESX.TriggerServerCallback('7918c675-c9e6-418a-8822-cb8250df0de3', function()
						OpenManageGradesMenu(society)
...
RegisterNetEvent('bec3a794-8bb9-441b-8fc0-f14a2def5a4c')
AddEventHandler('bec3a794-8bb9-441b-8fc0-f14a2def5a4c', function(society, money)
	if PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss' and 'society_' .. PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	end
end)

AddEventHandler('9878e951-0ff0-4996-be7e-f0eb7c427247', function(society, close, options)
