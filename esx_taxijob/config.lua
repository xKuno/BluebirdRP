...
Config.NPCJobEarnings             = {min = 40, max = 85}
...
Config.Zones = {
	...
	VehicleSpawner = {
		Pos   = {x = 906.93328857422, y = -154.01570129395, z = 73.168334960938},
	...
	VehicleSpawnPoint = {
		Pos     = {x = 918.67913818359, y = -159.48330688477, z = 74.961769104004},
		Size    = {x = 1.5, y = 1.5, z = 1.0},
		Type    = -1,
		Heading = 225.0
	},
	...
	TaxiActions = {
		Pos   = {x = 897.301940, y = -171.817848754, z = 73.669639},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 1
	},
	Cloakroom = {
		Pos     = {x = 900.12072753906, y = -166.879348754, z = 73.168350219727},
		Size    = {x = 1.5, y = 1.5, z = 1.0},
		Color   = {r = 204, g = 204, b = 0},
		Type    = 1
	}
