...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'tequil' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function OpenCloakroomMenu()
  ...
  TriggerEvent(   'esx_jb_dj:enabledjbooth', true,"nightclubteqil")
    ...
    ESX.TriggerServerCallback('8def0e18-67f6-4500-a5e2-6e16aee4eb00', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('293760c8-b5e2-4800-bc04-944c4b572970', 'tequil', vehicleProps)
...
function OpenSocietyActionsMenu()
  ...
  if (PlayerData.job.grade > 1 or IsGradeBoss()) then
      ...
      if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
              ...
              function(data2, menu2)
                ...
                TriggerServerEvent('c40c6199-257b-4b63-96a7-7d8fc4d14592', data2.current.value)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('c9ac0436-8b83-467d-abe5-4978cdf78f9b', GetPlayerServerId(player), 'society_tequilala', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('5d0c83dd-e23b-481c-80fa-bbed66c3ba9e', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('be9c840c-aa22-499b-bd89-5551025a8d5c', itemName, count)
            end
...
ESX.TriggerServerCallback('75b1cedb-2262-4d74-a302-e95662467100', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('7ec14172-48ce-4486-9d92-5c9f465e3bb1', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('1411bf76-2ff5-43d7-84af-953bc09833fa', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('1fe8f467-9e84-47b8-ae32-f167004bd136', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('38ebe157-7ba0-484c-a2e3-6acaf2e23ebc', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('ca0f0678-c7a4-4c79-abf9-248c3ca6e920', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('f32beaaa-0966-4084-9860-17a52a2a96e5', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('ab386391-2956-4dac-8529-50166ed8ecd3', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
--Flacons
    ...
    ESX.UI.Menu.Open(
        ...
        function(data, menu)
            TriggerServerEvent('f249eb79-faab-4fa3-89c9-e8ebe99d0826', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('4a2764d0-0caf-4636-9fcb-d7c2ffc74f0d', function(zone)
...
AddEventHandler('b0b62e44-69db-4e1e-ac71-b2acf98652a8', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('4a2764d0-0caf-4636-9fcb-d7c2ffc74f0d', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('b0b62e44-69db-4e1e-ac71-b2acf98652a8', LastZone)
            end
		else
			Wait(10000)
...
Citizen.CreateThread(function()
  while true do
	...
	if IsJobTrue() then
		  ...
		  if IsControlJustReleased(0,  Keys['E']) then
			...
			if CurrentAction == 'delete_vehicle' then
			  ...
			  if Config.EnableSocietyOwnedVehicles then
				...
				TriggerServerEvent('ee25e8b0-b555-4cd2-b500-24c1cbd32f88', 'tequil', vehicleProps)
				...
				then
				  TriggerServerEvent('a91f16e6-8b39-4118-b7d3-68f32f337985', 'tequil')
				end
			...
			if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
			  ...
			  TriggerEvent('9878e951-0ff0-4996-be7e-f0eb7c427247', 'tequil', function(data, menu)
		...
		if IsControlJustReleased(0,  Keys['F6'])  and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'unicorn_actions') then
...
AddEventHandler('e75f0537-5e82-4ab3-b53c-055073d3b236', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
          TriggerEvent('e75f0537-5e82-4ab3-b53c-055073d3b236', position)
        end
