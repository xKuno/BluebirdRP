...
Config.AuthorizedVehicles = {
    { name = 'rentalbus',  label = 'Tequilala Bus' },
}

Config.Blips = {

    Blip = {
      Pos     = { x = -564.94 , y = 271.66, z = 83.02 },
      Sprite  = 93,
      Display = 4,
      Scale   = 1.3,
      Colour  = 46,
...
Config.Zones = {
    ...
    Vehicles = {
        Pos          = { x = -562.01, y = 299.5, z = 50.07},
        SpawnPoint   = {  x = -562.01, y = 299.5, z = 50.07},
