Locales['en'] = {
    ...
    ['unicorn_fridge_stock']     = 'Fridge of the Tequi-la-la',
    ['fridge_inventory']         = 'Content of the fridge',
  
    -- Shops  
    ['shop']                     = 'Tequi-la-la Shop',
    ...
    ['quantity']                 = 'Amount',
    ['inventory']                = 'Inventory',
    ['unicorn_stock']            = 'Stock of Tequi-la-la',
    ...
    -- Misc  
    ['map_blip']                 = 'Tequil la la',
    ['unicorn']                  = 'Tequil la la',
  
    -- Phone  
    ['unicorn_phone']            = 'Tequil',
