...
Config.AuthorizedVehicles = {
    { name = 'rentalbus',  label = 'Vanilla Unicorn Bus' },
	 { name = 'ffhvan',  label = 'Vanilla Unicorn Van' },
	 { name = 'scretch',  label = 'Stretch Limo' },
}
...
Config.Zones = {
    ...
    Vaults = {
        Pos   = { x = 93.406, y = -1291.753, z = -10.288 },
    ...
    Fridge = {
        Pos   = { x = 135.478, y = -1288.615, z = -10.289 },
...
-------- SHOPS --------
    ...
    Flacons = {
        Pos   = vector3(91.114852905273,-1288.6232910156,28.255495071411),
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
        Color = { r = 238, g = 0, b = 0 },
        Type  = 23,
        Items = {
			...
			{ name = 'wine_white',    label = 'White Wine', price = 5 },
			{ name = 'wine_red',    label = 'Red Wine', price = 5 },
			{ name = 'shot_gin',    label = 'Shot Gin', price = 5 },
			
			{ name = 'drink_whiterussian',    label = 'White Russian', price = 5 },
			{ name = 'drink_unicorndust',    label = 'Unicorn Dust', price = 5 },
			{ name = 'drink_rule9onbeach',    label = 'Rule 9 on the Beach', price = 5 },
			{ name = 'drink_sevendeadlysins',    label = 'Seven Deadly Sins', price = 5 },
			{ name = 'drink_cherrychapstick',    label = 'Cherry Chapstick', price = 5 },
			{ name = 'drink_fruitylexia',    label = 'Fruit Lexia', price = 5 },
    ...
    NoAlcool = {
        Pos   = vector3(93.443969726562,-1288.0913085938,28.255495071411),
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
        ...
        Items = {
			...
			{ name = 'cola',    label = 'Coke', price = 5 }
        },
    },

    Apero = {
        Pos   = vector3(93.582641601562,-1291.7587890625,28.255495071411),
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
        ...
        Items = {
            ...
            { name = 'grapperaisin',    label = _U('grapperaisin'),     price = 10 },
			{ name = 'food_pizza',    label = 'Pizza',     price = 10 },
			{ name = 'snack_cupcake',    label = 'Cupcake',     price = 5 },
			{ name = 'snack_kebab',    label = 'Kebab',     price = 5 },
			{ name = 'snack_hsp',    label = 'HSP',     price = 5 },
			{ name = 'snack_spicywings',    label = 'Spicy Wings',     price = 5 },
			{ name = 'snack_chickenstrips',    label = 'Spicy Wings',     price = 5 },
    ...
    Ice = {
        Pos   = vector3(101.75618743896,-1316.1809082031,28.265426635742),
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
