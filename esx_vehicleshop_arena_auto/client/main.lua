...
Citizen.CreateThread(function ()
	...
	ESX.TriggerServerCallback('8fbcba2e-ee46-44ae-99f5-f968931e6cca', function (categories)
		Categories = categories
	end)
	
	

	ESX.TriggerServerCallback('fd8d8a5f-d736-4210-8de8-ec585c200cfa', function (vehicles)
		Vehicles = vehicles
	end)
...
RegisterNetEvent('93552f87-4dad-4567-a393-10fc786baa37')
AddEventHandler('93552f87-4dad-4567-a393-10fc786baa37', function (categories)
	Categories = categories
end)

RegisterNetEvent('122d34cf-be7e-4418-873d-784ee5f9e898')
AddEventHandler('122d34cf-be7e-4418-873d-784ee5f9e898', function (vehicles)
	Vehicles = vehicles
end)
...
function ReturnVehicleProvider()
	ESX.TriggerServerCallback('b1682b17-dfe4-4423-9298-59239dbcfd1b', function (vehicles)
		local elements = {}
		local returnPrice
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_provider_menu',
		{
			...
			TriggerServerEvent('29b39db4-c7b4-4637-8dcb-a02d20b409d3', data.current.value)
      ...
      ESX.UI.Menu.Open(
        ...
        function (data2, menu2)
          if data2.current.value == 'yes' then
            if Config.EnablePlayerManagement then
              ESX.TriggerServerCallback('c39ae325-3a1a-4835-bb01-0bccb2f8fc24', function (hasEnoughMoney)
                ...
                ESX.UI.Menu.Open(
                  ...
                  function (data3, menu3)
                    ...
                    if data3.current.value == 'personnal' then
                      ESX.TriggerServerCallback('88029014-726b-46e5-a8a7-8458ff01b6ac', function (hasEnoughMoney)
                        if hasEnoughMoney then
                          IsInShopMenu = false
						...
						Citizen.Trace('Primary Color Reg: ')
                          ...
                          ESX.Game.SpawnVehicle(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
                            ...
                            if Config.EnableOwnedVehicles then
                              TriggerServerEvent('85790276-9cd8-4584-8489-098c5ece68da', vehicleProps, vehname, primary)
                            end
                      ...
                      ESX.TriggerServerCallback('c39ae325-3a1a-4835-bb01-0bccb2f8fc24', function (hasEnoughMoney)
                        if hasEnoughMoney then
                          ...
                          ESX.Game.SpawnVehicle(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
                            ...
                            SetVehicleNumberPlateText(vehicle, newPlate)
							SetEntityAsMissionEntity(vehicle,true,true)
                            TriggerServerEvent('ec77119b-1f99-4656-8822-95be49e11fa8', playerData.job.name, vehicleProps)
  ...
  ESX.UI.Menu.Open(
    ...
    function (data, menu)
      ...
      if action == 'buy_vehicle' then
	  	ESX.TriggerServerCallback('7e056135-fd75-4e9d-bfcc-d6e1099e0013', function (resp)
			if resp then
				print('response was true from server')
				 OpenShopMenu()
				 ESX.ShowNotification('~g~Welcome, ~w~to the ~o~very best~w~ in offroad motoring.')
			else
				ESX.ShowNotification('~o~Sorry ~w~this vehicle dealership is for ~b~BlueBird Whitelist/~y~GOLD+~g~subscribers~w~ only. Make way.')
			end
		end)
      ...
      elseif action == 'set_vehicle_owner_sell' then
        ...
        if closestPlayer == -1 or closestDistance > 3.0 then
          ...
          TriggerServerEvent('969a7864-9995-485b-9342-3713e1a87896', model)

          if Config.EnableOwnedVehicles then
            TriggerServerEvent('85c5435c-0d45-44e7-b135-d06c70487930', GetPlayerServerId(closestPlayer), vehicleProps,vehname, primary)
        ...
        if closestPlayer == -1 or closestDistance > 3.0 then
          ...
          ESX.TriggerServerCallback('51d8bbd2-80ed-4c38-9e84-321449b2847c', function (xPlayer)
            ...
            if Config.EnableSocietyOwnedVehicles then
              TriggerServerEvent('ec77119b-1f99-4656-8822-95be49e11fa8', xPlayer.job.name, vehicleProps)
              ESX.ShowNotification(_U('vehicle_set_owned', vehicleProps.plate, GetPlayerName(closestPlayer)))
            else
              ESX.ShowNotification(_U('vehicle_sold_to', vehicleProps.plate, GetPlayerName(closestPlayer)))
            end
          ...
          function (data2, menu)
            ...
            if amount == nil then
              ...
              if closestPlayer == -1 or closestDistance > 5.0 then
                ...
                TriggerServerEvent('e0d80526-3b1d-49ae-ae71-cf9d334f8f28', model, vehicleProps.plate, GetPlayerName(closestPlayer), CurrentVehicleData.price, amount, GetPlayerServerId(closestPlayer))

                if Config.EnableOwnedVehicles then
                  TriggerServerEvent('85c5435c-0d45-44e7-b135-d06c70487930', GetPlayerServerId(closestPlayer), vehicleProps)
                end

                ESX.ShowNotification(_U('vehicle_set_rented', vehicleProps.plate, GetPlayerName(closestPlayer)))

                TriggerServerEvent('33528cca-2f9c-4a4d-8839-7d6565b5e2b0', vehicleProps, Config.Zones.ShopInside.Pos.x, Config.Zones.ShopInside.Pos.y, Config.Zones.ShopInside.Pos.z, 5.0)
              end
            end
          end,
          function (data2, menu)
...
function OpenPersonnalVehicleMenu()
  ...
  ESX.TriggerServerCallback('607b8b06-3ea6-448b-a50c-68aa1c956e6a', function (vehicles)
    local elements = {}
...
function OpenRentedVehiclesMenu ()
  ESX.TriggerServerCallback('948f4e7f-09e0-40ed-9587-f4bda8fb4cce', function (vehicles)
    local elements = {}
...
function OpenGetStocksMenu ()
  ESX.TriggerServerCallback('0ecc84a0-9765-4a85-aa6d-68633eb9405c', function (items)
    local elements = {}
        ...
        ESX.UI.Menu.Open(
          ...
          function (data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('7ede3a23-0e48-4abe-872f-7f2f920673d5', itemName, count)
              menu2.close()
              menu.close()
              OpenGetStocksMenu()
...
function OpenPutStocksMenu ()
  ESX.TriggerServerCallback('e68b6ec2-e045-4dc0-b3ba-b58599031c72', function (inventory)
    local elements = {}
        ...
        ESX.UI.Menu.Open(
          ...
          function (data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('a0750abf-f411-4fc8-af24-f937a764fe30', itemName, count)
              menu2.close()
              menu.close()
              OpenPutStocksMenu()
            end
...
RegisterNetEvent('b9b2f24b-8441-4e76-b691-d32ea300a4c9')
AddEventHandler('b9b2f24b-8441-4e76-b691-d32ea300a4c9', function ()
  OpenPersonnalVehicleMenu()
end)

AddEventHandler('17f50fc6-07e0-4231-9782-ca0e980f94da', function (zone)
...
AddEventHandler('27143a47-b795-4566-86e2-e3dbfb90520e', function (zone)
	...
	while true do
		...
		if closer then
			...
			if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
				...
				TriggerEvent('17f50fc6-07e0-4231-9782-ca0e980f94da', currentZone)
			end

			if not isInMarker and HasAlreadyEnteredMarker then
				HasAlreadyEnteredMarker = false
				TriggerEvent('27143a47-b795-4566-86e2-e3dbfb90520e', LastZone)
			end
		else
			Wait(5000)
		end
			...
			if CurrentAction == nil then
				...
				if IsControlJustReleased(0, Keys['E']) then
					if CurrentAction == 'shop_menu' then
						ESX.TriggerServerCallback('7e056135-fd75-4e9d-bfcc-d6e1099e0013', function (resp)
							if resp then
								print('response was true from server')
								 OpenShopMenu()
								 ESX.ShowNotification('~g~Welcome, ~w~to the best in offroad motoring... ~b~ARENA~w~ offroad autos ')
							else
								ESX.ShowNotification('~o~Sorry ~w~this vehicle dealership is for Whitelist/~y~GOLD~w~ Supporters only!')
							end
						end)
					elseif CurrentAction == 'reseller_menu' then
						OpenResellerMenu()
					elseif CurrentAction == 'give_back_vehicle' then
						ESX.TriggerServerCallback('743e09b4-f543-4e2c-ab86-18d3cbca8330', function (isRentedVehicle)
					...
					elseif CurrentAction == 'resell_vehicle' then
						ESX.TriggerServerCallback('8f07c528-7b87-4ef9-b973-a11b7c898886', function (isOwnedVehicle)
