...
Citizen.CreateThread(function ()
	...
	ESX.TriggerServerCallback('6940e83f-3a6a-4619-a449-0954fe732d53', function (categories)
		Categories = categories
	end)
	
	

	ESX.TriggerServerCallback('a68dc6ee-c5ea-4ac1-a37b-bb59f5fc4c4b', function (vehicles)
		Vehicles = vehicles
	end)
...
RegisterNetEvent('c5be460b-8fb9-44d3-9dc2-53e1a7652287')
AddEventHandler('c5be460b-8fb9-44d3-9dc2-53e1a7652287', function (categories)
	Categories = categories
end)

RegisterNetEvent('71c7c61d-6431-4e2b-8f6c-e603030e5600')
AddEventHandler('71c7c61d-6431-4e2b-8f6c-e603030e5600', function (vehicles)
	Vehicles = vehicles
end)
...
function ReturnVehicleProvider()
	ESX.TriggerServerCallback('414524d7-8ace-4744-9f98-b3816187a2cb', function (vehicles)
		local elements = {}
		local returnPrice
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_provider_menu',
		{
			...
			TriggerServerEvent('be8683ea-ac28-4fc6-b5f1-3f58be50b3de', data.current.value)
      ...
      ESX.UI.Menu.Open(
        ...
        function (data2, menu2)
          if data2.current.value == 'yes' then
            if Config.EnablePlayerManagement then
              ESX.TriggerServerCallback('ac239737-4f44-4c55-b3cd-325aad2cdca7', function (hasEnoughMoney)
              ...
              end, 'cardealer3', vehicleData.model)
                ...
                ESX.UI.Menu.Open(
                  ...
                  function (data3, menu3)
                    ...
                    if data3.current.value == 'personnal' then
                      ESX.TriggerServerCallback('b664430f-2241-4a0b-acb5-08b6e2665ffa', function (hasEnoughMoney)
                        if hasEnoughMoney then
                          IsInShopMenu = false
                          ...
                          ESX.Game.SpawnVehicleClient(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
                            ...
                            if Config.EnableOwnedVehicles then
							  if tonumber(vehicleProps.model) ~= 0 then
									TriggerServerEvent('ff5a2c88-6d13-4504-961a-806de85edd2a', vehicleProps, vehname, primary)
							  else
									TriggerServerEvent('d61d2033-aac7-4f69-8bf6-ea6c643a6fe2')
							  end
                            end
                      ...
                      ESX.TriggerServerCallback('ac239737-4f44-4c55-b3cd-325aad2cdca7', function (hasEnoughMoney)
                        if hasEnoughMoney then
                          ...
                          ESX.Game.SpawnVehicleClient(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
                            ...
                            SetVehicleNumberPlateText(vehicle, newPlate)
							SetEntityAsMissionEntity(vehicle,true,true)
                            TriggerServerEvent('27efb240-4469-427f-b1d0-8181cc061f3b', playerData.job.name, vehicleProps)
  ...
  ESX.UI.Menu.Open(
    ...
    function (data, menu)
      ...
      if action == 'buy_vehicle' then
	  	ESX.TriggerServerCallback('f63fe345-33aa-47d1-af87-ff683199e345', function (resp)
			if resp then
				 OpenShopMenu()
				 ESX.ShowNotification('~g~Welcome~w~, to the ~o~very best~w~ in ~y~luxury ~w~motoring.')
			else
          ...
          function (data2, menu)
            ...
            if amount == nil then
              ...
              if closestPlayer == -1 or closestDistance > 3.0 then
                ...
                TriggerServerEvent('c9ac0436-8b83-467d-abe5-4978cdf78f9b', GetPlayerServerId(closestPlayer), 'society_cardealer3', _U('car_dealer3'), tonumber(data2.value))
              end
            end
          end,
          function (data2, menu)
          ...
          ESX.ShowNotification(_U('no_players'))
			  ...
			  local model        = CurrentVehicleData.model
				if tonumber(vehicleProps.model) ~= 0 then
					  ...
					  TriggerServerEvent('5f1831d4-ef0c-4c94-b89d-b97efff89b6b', model)

					  if Config.EnableOwnedVehicles then
						TriggerServerEvent('39d5045d-f145-4e8e-958c-595c627b434c', GetPlayerServerId(closestPlayer), vehicleProps,vehname, primary)
					...
					ESX.ShowNotification('~o~Unable to sell this vehicle as it could not be found.~w~No money has been deducted.')
        ...
        if closestPlayer == -1 or closestDistance > 3.0 then
          ...
          ESX.TriggerServerCallback('51d8bbd2-80ed-4c38-9e84-321449b2847c', function (xPlayer)
            ...
            if Config.EnableSocietyOwnedVehicles then
              TriggerServerEvent('27efb240-4469-427f-b1d0-8181cc061f3b', xPlayer.job.name, vehicleProps)
              ESX.ShowNotification(_U('vehicle_set_owned', vehicleProps.plate, GetPlayerName(closestPlayer)))
            else
              ESX.ShowNotification(_U('vehicle_sold_to', vehicleProps.plate, GetPlayerName(closestPlayer)))
            end
          ...
          function (data2, menu)
            ...
            if amount == nil then
              ...
              if closestPlayer == -1 or closestDistance > 5.0 then
                ...
                TriggerServerEvent('0ec8990e-b9b8-4b12-b924-756d76f9236b', model, vehicleProps.plate, GetPlayerName(closestPlayer), CurrentVehicleData.price, amount, GetPlayerServerId(closestPlayer))

                if Config.EnableOwnedVehicles then
                  TriggerServerEvent('39d5045d-f145-4e8e-958c-595c627b434c', GetPlayerServerId(closestPlayer), vehicleProps)
                end

                ESX.ShowNotification(_U('vehicle_set_rented', vehicleProps.plate, GetPlayerName(closestPlayer)))

                TriggerServerEvent('c6ce22cc-ef2d-4b1a-aa02-af10ee4a6fc9', vehicleProps, Config.Zones.ShopInside.Pos.x, Config.Zones.ShopInside.Pos.y, Config.Zones.ShopInside.Pos.z, 5.0)
              end
            end
          end,
          function (data2, menu)
...
function OpenPersonnalVehicleMenu()
  ...
  ESX.TriggerServerCallback('3c443bc8-5179-42f8-af2b-c30a3a052cf7', function (vehicles)
    local elements = {}
...
function OpenRentedVehiclesMenu ()
  ESX.TriggerServerCallback('6d98222a-e525-40a6-a7f1-4ced9417dd20', function (vehicles)
    local elements = {}
  ...
  ESX.UI.Menu.Open(
    ...
    function (data, menu)
      if data.current.value == 'boss_actions' then
        TriggerEvent('9878e951-0ff0-4996-be7e-f0eb7c427247', 'cardealer3', function(data, menu)
          menu.close()
        end)
      end
    end,
...
function OpenGetStocksMenu ()
  ESX.TriggerServerCallback('4acf3e8d-9d3f-4254-9949-063baac6938c', function (items)
    local elements = {}
        ...
        ESX.UI.Menu.Open(
          ...
          function (data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('a7ac0ad6-07ee-4d87-a8a0-d4d59e04c243', itemName, count)
              menu2.close()
              menu.close()
              OpenGetStocksMenu()
...
function OpenPutStocksMenu ()
  ESX.TriggerServerCallback('e914c2a7-af08-4cc1-8f1b-191eb57fb8fc', function (inventory)
    local elements = {}
        ...
        ESX.UI.Menu.Open(
          ...
          function (data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('51109ca4-130b-42ba-9866-590a423aa916', itemName, count)
              menu2.close()
              menu.close()
              OpenPutStocksMenu()
            end
...
RegisterNetEvent('9f6d0acb-dd96-496e-839d-654bddb587de')
AddEventHandler('9f6d0acb-dd96-496e-839d-654bddb587de', function ()
  OpenPersonnalVehicleMenu()
end)

AddEventHandler('cf694d8e-2374-43e4-b54e-1e7e6293e351', function (zone)
  if zone == 'ShopEntering' then
    if Config.EnablePlayerManagement then
      if ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'cardealer3' then
        CurrentAction     = 'reseller_menu'
        CurrentActionMsg  = _U('shop_menu')
        CurrentActionData = {}
      end
  ...
  if zone == 'BossActions' and Config.EnablePlayerManagement and ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'cardealer3' and ESX.PlayerData.job.grade_name == 'boss' then
    CurrentAction     = 'boss_actions_menu'
    CurrentActionMsg  = _U('shop_menu')
    CurrentActionData = {}
  end
...
AddEventHandler('49974551-2944-4422-8a79-81fa6422244d', function (zone)
...
Citizen.CreateThread(function ()
	...
	AddTextComponentString('Supporter Dealership')
	...
	while true do
		...
		if closer then
			...
			if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
				...
				TriggerEvent('cf694d8e-2374-43e4-b54e-1e7e6293e351', currentZone)
			end

			if not isInMarker and HasAlreadyEnteredMarker then
				HasAlreadyEnteredMarker = false
				TriggerEvent('49974551-2944-4422-8a79-81fa6422244d', LastZone)
			end
		else
			Wait(3000)
		end
			...
			if CurrentAction == nil then
				...
				if IsControlJustReleased(0, Keys['E']) then
						...
						ESX.TriggerServerCallback('f63fe345-33aa-47d1-af87-ff683199e345', function (resp)
							if resp then
								print('response was true from server')
								 OpenShopMenu()
								 ESX.ShowNotification('~g~Welcome ~w~Sir, to the best in luxury motoring... ~b~BlueBird~g~ Supporter')
							else
								ESX.ShowNotification('~o~Sorry ~w~this vehicle dealership is for ~b~BlueBird~w~ supporters only. Know the difference. Get out!')
							end
						end)
					elseif CurrentAction == 'reseller_menu' then
						OpenResellerMenu()
					elseif CurrentAction == 'give_back_vehicle' then
						ESX.TriggerServerCallback('45712b0a-b424-49a0-878f-e24897ba51d9', function (isRentedVehicle)
					...
					elseif CurrentAction == 'resell_vehicle' then
						ESX.TriggerServerCallback('e226e217-2d6d-4c70-b8ee-dc939b537384', function (isOwnedVehicle)
