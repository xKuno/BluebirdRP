...
Citizen.CreateThread(function ()
	...
	ESX.TriggerServerCallback('6a57f626-6b33-4f61-9a0c-f6c5944c46c9', function (categories)
		Categories = categories
	end)

	ESX.TriggerServerCallback('ee82cbad-4d77-482c-9937-304ea3c1aedd', function (vehicles)
		Vehicles = vehicles
	end)
...
RegisterNetEvent('9b5bd972-0a8c-45f5-8c48-7499138e7221')
AddEventHandler('9b5bd972-0a8c-45f5-8c48-7499138e7221', function (categories)
	Categories = categories
end)

RegisterNetEvent('71b9444c-02ba-4112-93d6-8b46e9ce8afa')
AddEventHandler('71b9444c-02ba-4112-93d6-8b46e9ce8afa', function (vehicles)
	Vehicles = vehicles
end)
...
function ReturnVehicleProvider()
	ESX.TriggerServerCallback('084b9c29-d87b-4459-8704-30386933a037', function (vehicles)
		local elements = {}
		local returnPrice
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_provider_menu',
		{
			...
			TriggerServerEvent('c49a00c2-68da-41dc-8b7a-d8515a471397', data.current.value)
      ...
      ESX.UI.Menu.Open(
        ...
        function (data2, menu2)
          if data2.current.value == 'yes' then
            if Config.EnablePlayerManagement then
              ESX.TriggerServerCallback('c6ce56d4-4a57-42dc-9abf-2bf7f1d6b7e3', function (hasEnoughMoney)
                ...
                ESX.UI.Menu.Open(
                  ...
                  function (data3, menu3)
                    ...
                    if data3.current.value == 'personnal' then
                      ESX.TriggerServerCallback('1ea625d9-1ce5-4e98-b179-e942bd446058', function (hasEnoughMoney)
                        if hasEnoughMoney then
                          IsInShopMenu = false
						...
						Citizen.Trace('Primary Color Reg: ')
                          ...
                          ESX.Game.SpawnVehicleClient(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
                            ...
                            if Config.EnableOwnedVehicles then
                              TriggerServerEvent('91501256-c966-450e-abaf-a9fd444cd9fa', vehicleProps, vehname, primary)
                            end
                      ...
                      ESX.TriggerServerCallback('c6ce56d4-4a57-42dc-9abf-2bf7f1d6b7e3', function (hasEnoughMoney)
                        if hasEnoughMoney then
                          ...
                          ESX.Game.SpawnVehicleClient(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
                            ...
                            SetVehicleNumberPlateText(vehicle, newPlate)
							SetEntityAsMissionEntity(vehicle,true,true)
                            TriggerServerEvent('8c211bce-72cb-4ff1-ab01-8729de3f6f97', playerData.job.name, vehicleProps)
    ...
    function (data, menu)
          ...
          function (data2, menu)
            ...
            if amount == nil then
              ...
              if closestPlayer == -1 or closestDistance > 3.0 then
                ...
                TriggerServerEvent('c9ac0436-8b83-467d-abe5-4978cdf78f9b', GetPlayerServerId(closestPlayer), 'society_cardealer_sandy', _U('car_dealer'), tonumber(data2.value))
              end
            end
          end,
          function (data2, menu)
      ...
      elseif action == 'set_vehicle_owner_sell' then
        ...
        if closestPlayer == -1 or closestDistance > 3.0 then
          ...
          TriggerServerEvent('dc43fc75-695f-4c7c-8322-26ce582777a3', model)

          if Config.EnableOwnedVehicles then
            TriggerServerEvent('016a4f41-7f7d-4bee-9121-eecfda227b5f', GetPlayerServerId(closestPlayer), vehicleProps,vehname, primary)
        ...
        if closestPlayer == -1 or closestDistance > 3.0 then
          ...
          ESX.TriggerServerCallback('51d8bbd2-80ed-4c38-9e84-321449b2847c', function (xPlayer)
            ...
            if Config.EnableSocietyOwnedVehicles then
              TriggerServerEvent('8c211bce-72cb-4ff1-ab01-8729de3f6f97', xPlayer.job.name, vehicleProps)
              ESX.ShowNotification(_U('vehicle_set_owned', vehicleProps.plate, GetPlayerName(closestPlayer)))
            else
              ESX.ShowNotification(_U('vehicle_sold_to', vehicleProps.plate, GetPlayerName(closestPlayer)))
            end
          ...
          function (data2, menu)
            ...
            if amount == nil then
              ...
              if closestPlayer == -1 or closestDistance > 5.0 then
                ...
                TriggerServerEvent('78908177-b4ac-469f-8bfe-0e327ce3f14a', model, vehicleProps.plate, GetPlayerName(closestPlayer), CurrentVehicleData.price, amount, GetPlayerServerId(closestPlayer))

                if Config.EnableOwnedVehicles then
                  TriggerServerEvent('016a4f41-7f7d-4bee-9121-eecfda227b5f', GetPlayerServerId(closestPlayer), vehicleProps)
                end

                ESX.ShowNotification(_U('vehicle_set_rented', vehicleProps.plate, GetPlayerName(closestPlayer)))

                TriggerServerEvent('f2dd4fd8-d7fb-4960-aadf-7afb23551e3e', vehicleProps, Config.Zones.ShopInside.Pos.x, Config.Zones.ShopInside.Pos.y, Config.Zones.ShopInside.Pos.z, 5.0)
              end
            end
          end,
          function (data2, menu)
...
function OpenPersonnalVehicleMenu()
  ...
  ESX.TriggerServerCallback('7f3c1eff-0b33-4c6a-b2a0-2c8923a15c34', function (vehicles)
    local elements = {}
...
function OpenRentedVehiclesMenu ()
  ESX.TriggerServerCallback('0b4a6cd8-d171-4667-acd9-f380def66c5a', function (vehicles)
    local elements = {}
...
function OpenGetStocksMenu ()
  ESX.TriggerServerCallback('d001c458-b703-4049-a918-bb73ace8472b', function (items)
    local elements = {}
        ...
        ESX.UI.Menu.Open(
          ...
          function (data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('80feaa2a-1915-4da0-ac0e-792bdcafc068', itemName, count)
              menu2.close()
              menu.close()
              OpenGetStocksMenu()
...
function OpenPutStocksMenu ()
  ESX.TriggerServerCallback('882eb6d7-d11d-4e39-8482-07ecf5a5fc20', function (inventory)
    local elements = {}
        ...
        ESX.UI.Menu.Open(
          ...
          function (data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('0dd163b5-8d29-4428-9690-458f91b6b4ed', itemName, count)
              menu2.close()
              menu.close()
              OpenPutStocksMenu()
            end
...
RegisterNetEvent('59a7587c-cc2d-440f-86e3-e498e4523d48')
AddEventHandler('59a7587c-cc2d-440f-86e3-e498e4523d48', function ()
  OpenPersonnalVehicleMenu()
end)

AddEventHandler('3d41b82f-9d7d-4c2e-8914-c5c5d05e7a46', function (zone)
...
AddEventHandler('e5125199-0f46-4d30-95fa-9729d9dc165f', function (zone)
	...
	while true do
		...
		if closer then
			...
			if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
				...
				TriggerEvent('3d41b82f-9d7d-4c2e-8914-c5c5d05e7a46', currentZone)
			end

			if not isInMarker and HasAlreadyEnteredMarker then
				HasAlreadyEnteredMarker = false
				TriggerEvent('e5125199-0f46-4d30-95fa-9729d9dc165f', LastZone)
			end
		else
			Wait(3000)
		end
			...
			if CurrentAction == nil then
				...
				if IsControlJustReleased(0, Keys['E']) then
					...
					elseif CurrentAction == 'give_back_vehicle' then
						ESX.TriggerServerCallback('ddd7f86f-b225-49c3-a1a5-bb1119ef23c9', function (isRentedVehicle)
					...
					elseif CurrentAction == 'resell_vehicle' then
						ESX.TriggerServerCallback('fe0a4ab7-89d0-49ec-ab90-8944dbe5e68c', function (isOwnedVehicle)
