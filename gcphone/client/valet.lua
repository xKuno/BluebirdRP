...
RegisterNUICallback('getCars', function(data)
    ESX.TriggerServerCallback('df893efe-bb8d-42da-939a-0f654aed4b7c', function(data)
        for i = 1, #data do
...
RegisterNUICallback('getCarsValet', function(data)
    ...
    TriggerServerEvent('287f8676-a984-4e63-bf89-bc509b2f4d2e', data.props.plate)
...
function GoToTargetWalking(x, y, z, vehicle, driver)
    ...
    TriggerServerEvent('a07c0311-06e4-4b52-a1eb-88d76a63a657')
    Citizen.Wait(35000)
    DeletePed(mechPed)
    mechPed = nil
end
