...
local timeRunning = 0
local timeToRun = 60000
local shouldBeCounting = true
...
--RegisterCommand("goldmeth", function(...) DoAcid(115000); end)
RegisterNetEvent('ec0de5c5-cda4-40f8-a56c-8fc7061aca14')
AddEventHandler('ec0de5c5-cda4-40f8-a56c-8fc7061aca14', function()
	local playerPed = GetPlayerPed(-1)
	DoAcid(114500)
end)
