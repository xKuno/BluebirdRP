...
mumbleConfig = {
    ...
    voiceModes = {
        {1.7, "Whisper"}, -- Whisper speech distance in gta distance units
        {6.0, "Conversation"},
	...
	micClickVolume = 0.06, -- How loud a mic click is
	radioClickMaxChannel = 15, -- Set the max amount of radio channels that will have local radio clicks enabled
    ...
    radioChannelNames = { -- Add named radio channels (Defaults to [channel number] MHz)
		...
		[7] = "CFA PRIMARY",
		[8] = "CFA SECONDARY",
		[9] = "MULTI AGENCY PRIMARY",
		[10] = "MULTI AGENCY SECONDARY",
		[11] = "DOJ SHERIFF",
		[12] = "SECURITY",
		[13] = "ROADSIDE ASSIST",
		[20] = "GENERAL PUBLIC 1",
