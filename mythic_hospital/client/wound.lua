...
function CheckDamage(ped, bone, weapon)
    ...
    if parts[bone] ~= nil then
        if not BodyParts[parts[bone]].isDamaged then
            ...
            TriggerServerEvent('09482951-61e7-4259-bc5f-9096785894fa', {
                limbs = BodyParts,
...
RegisterNetEvent('8f3d6a26-735e-45e3-83fc-aeb6772361fc')
AddEventHandler('8f3d6a26-735e-45e3-83fc-aeb6772361fc', function(bleedStatus)
    isBleeding = tonumber(bleedStatus)
end)

RegisterNetEvent('10d273c6-7f42-45a4-9887-4a415e802e3a')
AddEventHandler('10d273c6-7f42-45a4-9887-4a415e802e3a', function()
    for k, v in pairs(BodyParts) do
        v.isDamaged = false
        v.severity = 1
    end
...
RegisterNetEvent('d2985e19-91d6-4cf5-9ebb-536b332c9cde')
AddEventHandler('d2985e19-91d6-4cf5-9ebb-536b332c9cde', function()
    for k, v in pairs(BodyParts) do
        v.isDamaged = false
        v.severity = 0
    end
...
RegisterNetEvent('e46b7b3e-aab2-48a1-9408-aefac0571071')
AddEventHandler('e46b7b3e-aab2-48a1-9408-aefac0571071', function()
    if isBleeding > 1 then
        isBleeding = tonumber(isBleeding) - 1
    end
end)

RegisterNetEvent('f98de4f9-1c51-457f-9964-3822f3ca7361')
AddEventHandler('f98de4f9-1c51-457f-9964-3822f3ca7361', function()
    if isBleeding > 0 then
        isBleeding = tonumber(isBleeding) - 1
    end
end)

RegisterNetEvent('15ba6364-24b3-438c-8d0c-a54a262fc7da')
AddEventHandler('15ba6364-24b3-438c-8d0c-a54a262fc7da', function()
    isBleeding = 0
end)

RegisterNetEvent('df0b1adc-dc62-4617-ab40-a73314ba34f5')
AddEventHandler('df0b1adc-dc62-4617-ab40-a73314ba34f5', function(tier)
    if tier < 4 then
...
RegisterNetEvent('d55a06a0-6d81-489a-ac21-da8da6e1e936')
AddEventHandler('d55a06a0-6d81-489a-ac21-da8da6e1e936', function(tier)
    if tier < 4 then
        onDrugs = 180 * tier
    end
