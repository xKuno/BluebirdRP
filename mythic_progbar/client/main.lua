            ...
            Citizen.CreateThread(function ()
                while isDoingAction do
                    ...
                    if IsControlJustPressed(0, 178) and mythic_action.canCancel then
                        TriggerEvent('0c38a992-fd5f-4c11-abe5-2011c596dc1e')
                    end
                end
                if finish ~= nil then
                    finish(wasCancelled)
...
function ProgressWithStartEvent(action, start, finish)
    ...
    if not IsEntityDead(GetPlayerPed(-1)) or mythic_action.useWhileDead then
        if not isDoingAction then
            ...
            TriggerEvent('759f007d-15fb-449f-9930-d9b833aecbae', { text = "Already Doing An Action", type = "error", layout = "topRight", timeout = 1500 })
        end
    else
        TriggerEvent('759f007d-15fb-449f-9930-d9b833aecbae', { text = "Cannot Perform An Action While Dead", type = "error", layout = "topRight", timeout = 1500 })
    end
end
...
RegisterNetEvent('cd82807f-1f8d-48cd-82fc-c4dcc0dfeb17')
AddEventHandler('cd82807f-1f8d-48cd-82fc-c4dcc0dfeb17', function(action, finish)
    Progress(action, finish)
end)

RegisterNetEvent('3510c1eb-b962-4172-b3cb-308ef9a1d9f6')
AddEventHandler('3510c1eb-b962-4172-b3cb-308ef9a1d9f6', function(action, start, finish)
    ProgressWithStartEvent(action, start, finish)
end)

RegisterNetEvent('1dc80f40-ea40-4701-a34d-a0c7d413680b')
AddEventHandler('1dc80f40-ea40-4701-a34d-a0c7d413680b', function(action, tick, finish)
    ProgressWithTickEvent(action, tick, finish)
end)

RegisterNetEvent('b5901cd7-0f4f-46e1-afec-61ac15ca82a2')
AddEventHandler('b5901cd7-0f4f-46e1-afec-61ac15ca82a2', function(action, start, tick, finish)
    ProgressWithStartAndTick(action, start, tick, finish)
end)

RegisterNetEvent('0c38a992-fd5f-4c11-abe5-2011c596dc1e')
AddEventHandler('0c38a992-fd5f-4c11-abe5-2011c596dc1e', function()
    isDoingAction = false
    wasCancelled = true

    TriggerEvent('4dd8ad7b-91c0-471c-8407-023b79b8f075')
...
RegisterNetEvent('4dd8ad7b-91c0-471c-8407-023b79b8f075')
AddEventHandler('4dd8ad7b-91c0-471c-8407-023b79b8f075', function()
