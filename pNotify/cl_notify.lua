...
RegisterNetEvent('61329ade-cca4-49b0-ae5e-47119f350c2d')
AddEventHandler('61329ade-cca4-49b0-ae5e-47119f350c2d', function(options)
    SendNotification(options)
end)

RegisterNetEvent('37549c09-9875-4772-88d4-3a27031a4a59')
AddEventHandler('37549c09-9875-4772-88d4-3a27031a4a59', function(queue, max)
    SetQueueMax(queue, max)
end)

--[[RegisterNetEvent("chatMessage")
AddEventHandler('chatMessage', function(author, color, text)
    TriggerEvent('61329ade-cca4-49b0-ae5e-47119f350c2d', {text = "<span style='font-weight: 900'>" .. text .. "</span>",
        layout = "centerLeft",
        timeout = 2000,
        progressBar = false,
        type = "error",
