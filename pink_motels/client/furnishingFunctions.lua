...
ButtonPressed = function(keyLabel)
    ...
    if DoesEntityExist(furHandle) then
        ...
        elseif keyLabel == "ENTER" then
            ...
            ESX.TriggerServerCallback('30a4d7c3-1848-4892-94a2-74d833b2c2b7', function(savedFurnishing)
...
ComputerTick = function(currentProp)
    local PurchaseProp = function()
        ...
        ESX.TriggerServerCallback('0fb2b0c6-3ebb-4323-a3e9-4457d70fd212', function(purchased)
