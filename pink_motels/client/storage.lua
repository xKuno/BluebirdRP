...
OpenStorage = function(storageId)
	...
	TriggerEvent('939224e0-dc6c-432f-9ac7-bcce6b95eaf7',storageId,storageId)

end

OpenStoragec = function(storageId)
...
AddItemToStorage = function(storageId, newItem)
    ...
    ESX.TriggerServerCallback('86f417c3-1255-4dd6-a428-51cf2c0a6cd9', function(updated)
        if updated then
...
TakeItemFromStorage = function(storageId, newItem)
    ...
    ESX.TriggerServerCallback('1174bd5e-9f22-42a0-98a1-fb9699222e76', function(updated)
        if updated then
