...
Config.Enabled = false -- Control if you can sell houses or not
Config.KeysEnabled = false -- Controls buying additional keys
...
Config.MotelPrice = 250000 -- this is the price that you will pay when you buy the motel.
Config.KeyPrice = 5000 -- this is the price for each key that you want to buy.
