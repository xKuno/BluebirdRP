...
XNL_CreateAirportBlips = falsese					-- Setting: This will automatically create blips on the map for airports where the aircraft is allowed to land at (and remove it when getting out again)
...
--=============================================================================================================================
-- Settings for the mammatus
-- Data is based on the Lockheed C-130 Hercules (But adapted a bit to suitable use for GTA V)
-- Note: Fly's in a flyzone 250m higher than the Titans and thus 400m higher than the shamals
--=============================================================================================================================
XNL_PlaneJetBankAngleLimit = 55.0				-- Setting: BankAngle limit for the Jet
XNL_PlaneJetSinkRateAngle = 0.0				-- Setting: Sinkrate (ANGLE) Limit for the Jet
XNL_PlaneJetSinkRateSpeed = 0.0				-- Setting: UPPER sinkrate (SPEED) limit for the Jet
...
XNL_PlaneJet_GPWS_CruiseHeightOK = 450.0		-- Setting: The Cruiseheight when it recognized that the takeoff has completed
XNL_PlaneJet_GPWS_CruiseHeightMax = 650.0		-- Setting: The maximum Cruiseheight allowed/Advised before reaching other airspaces
	...
	Citizen.CreateThread(function()
		while XNL_AircraftComputerOn do
			...
			if XNL_PlaneHudText ~= "" then
				drawTxt(0.6, 0.905, 0.55,  XNL_PlaneHudText .. "        ", 255, 255, 255, 255)
			else
				Wait(1000)
			end
		end
...
function GetCurrentAircraftSetting(EntityModel)
	...
	if EntityModel == GetHashKey('mammatus') then
