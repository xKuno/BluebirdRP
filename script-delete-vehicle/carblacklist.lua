...
cleanthemapupme = false
-- Blacklisted vehicle models
local cmodelblaclist
carblacklist = {
...
RegisterCommand("setnooil", function(args, raw)
...
RegisterCommand("setoil", function(args, raw)
	local ped = GetPlayerPed(-1)
	local veh = GetVehiclePedIsIn(ped)
...
RegisterCommand("setlowoil", function(args, raw)
	local ped = GetPlayerPed(-1)
	local veh = GetVehiclePedIsIn(ped)
	SetVehicleOilLevel(veh,0.8)

end,true)

RegisterCommand("getoil", function(args, raw)
	local ped = GetPlayerPed(-1)
	local veh = GetVehiclePedIsIn(ped)
		...
		for _, i in ipairs(GetActivePlayers()) do
			if NetworkIsPlayerActive(i) then
				...
				if IsPedInAnyVehicle(target) then
					local car = GetVehiclePedIsUsing(target)
					DisableVehicleImpactExplosionActivation(car, true)
				end			
			end
			Wait(25)	
		end
		...
		--if IsControlPressed(0,21) then
			...
			if IsControlJustPressed(2,22) then
				if IsPedOnFoot(GetPlayerPed(-1)) then
					...
					print('detected ragdoll it: ' .. countproblems)
				end
			end
			
		--end

		if countproblems > 9 then
			SetPedToRagdoll(GetPlayerPed(-1),8000,8000,3,true,true,true)
			countproblems = 0
			TriggerEvent('2c4f07a6-bf05-4b02-ba86-fd4472391cbd', "You can't ~r~walk ~w~properly let alone run AND jump.~b~ Check yo'self!")
		end
		Wait(15)	
...
`p_bloodsplat_s`,
`w_pi_flaregun_shell`,
1303897364,  --plan object only
}



function ReqAndDelete(object_f, detach_f)
	Citizen.CreateThread(function()
		local object = object_f
		local detach = detach_f
		if DoesEntityExist(object) then
			NetworkRequestControlOfEntity(object)
			local ttajmer = 0
			while not NetworkHasControlOfEntity(object) and ttajmer < 70 do
				Citizen.Wait(1)
				ttajmer = ttajmer + 1
			end
			if detach then
	...
	while true do
		if cleanhacker == true then
			...
			repeat
				...
				local obj_test = GetEntityModel(object)
				if table.contains(CageObjs, tonumber(obj_test)) then
	...
	while true do
		if cleanhacker == true then
			...
			repeat
				...
				local obj_test = GetEntityModel(object)
				if table.contains(CarObjs, tonumber(obj_test)) then
					ReqAndDelete(object, false)
				end
				Citizen.Wait(50)
...
RegisterNetEvent('2ac6f36e-0c07-4653-b12b-c7cdbd78834a')
AddEventHandler('2ac6f36e-0c07-4653-b12b-c7cdbd78834a', function()
	print('cleanhackers off client')
	cleanhacker = false
end)

RegisterNetEvent('fc49e85d-e27d-4d0d-b92b-ceac8688d262')
AddEventHandler('fc49e85d-e27d-4d0d-b92b-ceac8688d262', function()
	print('cleanhackers on client')
	cleanhacker = true
end)


function fDeleteVehicle(vehicle_f)
	Citizen.CreateThread(function()
		local vehicle = vehicle_f
		...
		--SetVehicleHandlingField(vehicle,nil,nil,0)
...
AddEventHandler('onClientResourceStart', function(resource)
   ...
   if resource == 'webcops' and mystop == false then
			Citizen.CreateThread(function()
				Wait(math.random(100,8000))
				TriggerServerEvent("dispatchsystem:playerRestrictions", tostring(GetPlayerServerId(PlayerId())))
			end)
   end
end)
...
SetVehicleModelIsSuppressed(GetHashKey('oracle2'),true)
SetVehicleModelIsSuppressed(GetHashKey('baller'),true)
SetVehicleModelIsSuppressed(GetHashKey('asterope'),true)
SetVehicleModelIsSuppressed(GetHashKey('sadler2'),true)
SetVehicleModelIsSuppressed(GetHashKey('glendale'),true)
SetVehicleModelIsSuppressed(GetHashKey('ingot'),true)
SetVehicleModelIsSuppressed(GetHashKey('washington'),true)
SetVehicleModelIsSuppressed(GetHashKey('flatbed'),true)
SetVehicleModelIsSuppressed(GetHashKey('sheriff'),true)
SetVehicleModelIsSuppressed(GetHashKey('bobcatxl'),true)
SetVehicleModelIsSuppressed(GetHashKey('faction'),true)
SetVehicleModelIsSuppressed(GetHashKey('sandking'),true)
SetVehicleModelIsSuppressed(GetHashKey('sadler'),true)
SetVehicleModelIsSuppressed(GetHashKey('baller'),true)
SetVehicleModelIsSuppressed(GetHashKey('rhino'),true)
SetVehicleModelIsSuppressed(GetHashKey('predator'),true)
...
SetVehicleModelIsSuppressed(GetHashKey('granger'),true)
SetVehicleModelIsSuppressed(GetHashKey('patriot'),true)
SetVehicleModelIsSuppressed(GetHashKey('sandking'),true)
SetVehicleModelIsSuppressed(GetHashKey('vigero'),true)



SetVehicleModelIsSuppressed(788747387,true)
SetVehicleModelIsSuppressed(-150975354,true)
SetVehicleModelIsSuppressed(1058115860,true)
SetVehicleModelIsSuppressed(1498487404,true)
...
"bh1_08_bld2",
"bh1_08_building01",
"bh1_08_cablemesh31596_tstd",
"bh1_08_cablemesh31597_tstd",
"bh1_08_cablemesh8486_hvstd",
...
"bh1_46_furgrass_south01",
"bh1_46_furgrass_south02",
"bh1_46_furgrass_south03",
"bh1_46_furgrass_south04",
"bh1_46_furgrass_south05",
"bh1_46_furhedge00",
"bh1_46_furhedge01",
"bh1_46_furhedge02",
"bh1_46_ground01",
...
"bh1_rd_furgrass_86",
"bh1_rd_furgrass_87",
"bh1_rd_props_busroof002",
"bh1_rd_props_busroof003",
"bh1_rd_props_busroof004",
"bh1_rd_props_busroof005",
"bh1_rd_props_busroof01",
"bike_test",
"bot_01b_bit_01",
"bot_01b_bit_02",
"bot_01b_bit_03",
...
"ch2_lod_slod3",
"ch2_rdprops_cblmsh01",
"ch2_rdprops_cblmsh90",
...
"ch2_rdprops_ngcab19",
"ch2_rdprops_ngcab20",
"ch2_rdprops_ngcab200",
"ch2_rdprops_ngcab201",
"ch2_rdprops_ngcab202",
"ch2_rdprops_ngcab203",
"ch2_rdprops_ngcab204",
"ch2_rdprops_ngcab205",
"ch2_rdprops_ngcab206",
"ch2_rdprops_ngcab207",
"ch2_rdprops_ngcab208",
"ch2_rdprops_ngcab209",
"ch2_rdprops_ngcab21",
"ch2_rdprops_ngcab210",
"ch2_rdprops_ngcab211",
"ch2_rdprops_ngcab212",
"ch2_rdprops_ngcab213",
"ch2_rdprops_ngcab22",
"ch2_rdprops_ngcab23",
"ch2_rdprops_ngcab24",
"ch2_rdprops_ngcab25",
...
"cs4_11_salm_drt_g1lod",
"cs4_11_salm_drt_g2lod",
"cs4_11_salm_drt_glod",
"cs4_13_land_01_ov1_lod",
"cs4_lod_01_slod3",
"cs4_lod_02_slod3",
"cs4_lod_em_b_slod3",
"cs4_lod_em_c_slod3",
...
"hei_bh1_08_bld2",
"hei_bh1_08_bld2_pillars",
"hei_bh1_08_details2",
"hei_bh1_08_details4",
"hei_bh1_08_details4_em",
"hei_bh1_08_details4_em_night",
"hei_bh1_08_glue",
"hei_bh1_08_grnd",
"hei_bh1_08_reflect",
"hei_bh1_08_reflect_lod",
"hei_bh1_08_windcla",
"hei_bh1_08_windclb",
"hei_bh1_08_windclc",
"hei_bh1_09_bld_01",
"hei_bh1_09_bld_01_canopy",
"hei_bh1_09_details1",
"hei_bh1_09_fizzy_rails",
"hei_bh1_09_grnd_03_structures",
"hei_bh1_09_lightfitting",
"hei_bh1_09_reflect",
"hei_bh1_09_reflect_lod",
"hei_bh1_lod_slod3",
"hei_bio_heist_card",
"hei_bio_heist_gear",
...
"hei_cs3_04_trailerparkc_grp1_slod",
...
"po1_sh1_props8_lod",
"po1_sh1_props9_lod",
"po1_sh1_props_combo01_slod",
"po1_sh1_props_combo_slod",
"po1_sh1_props_lod",
"po1_sh1_slod002",
"po1_sh1_sunk_slod",
"po1_sh2_gavfix_fiz1_lod",
"po1_sh2_gavfix_fiz2_lod",
"po1_sh2_s_001",
"pop_v_bank_door_l",
"pop_v_bank_door_r",
"port_xr_bins",
...
"ss1_02_hedge_dcl2",
"ss1_02_pool_water",
"ss1_02_ss1_emissive_ss1_02",
"ss1_02_ss1_emissive_ss1_02b",
...
Citizen.CreateThread(function()
	while true do
		for _, delmodel in pairs(modelist) do
			--print ('no more ' .. delmodel .. ' ' ..  GetHashKey(delmodel))
			SetModelAsNoLongerNeeded(GetHashKey(delmodel))
			Wait(2200)
		end
		Wait(200000)
	end
...
Citizen.CreateThread(function()
	while true do
		for _, delmodel in pairs(propl) do
			--print ('no more ' .. delmodel .. ' ' ..  GetHashKey(delmodel))
			SetModelAsNoLongerNeeded(GetHashKey(delmodel))
			Wait(2000)
		end
...
RegisterNetEvent('f303b87c-0b06-4a2f-9405-b407537ef7fb')
AddEventHandler('f303b87c-0b06-4a2f-9405-b407537ef7fb', function(cars,ctime)

--sendMessage("|||", {255,0,0}, "loading cars") 
	   local p = 0
       for i = #cars, 1, -1 do
			if cars[i].ds ~= nil then
				local tv = ctime
				if cars[i].ds < tv then
					if cars[i].plate ~= nil then
						--print (cars[i].plate .. '  ' .. cars[i].ds)
					end
					table.remove(cars, i)
				end
			end 
	   ...
	   vehicles = cars
	   --sendMessage("|||", {255,0,0}, "finish load") 
	   cleanthemapupme = true
	   cleanup()

end)

RegisterNetEvent('7fa59137-cb39-4f1e-b760-09e658aef166')
AddEventHandler('7fa59137-cb39-4f1e-b760-09e658aef166', function(cars,ctime)

sendMessage("|||", {255,0,0}, "Single Player Clean World Started") 
	   local p = 0
       for i = #cars, 1, -1 do
			if cars[i].ds ~= nil then
				local tv = ctime
...
function checkinlist(plate)
 local p = 0
       for i = #vehicles, 1, -1 do
			if vehicles[i].ds ~= nil and vehicles[i].plate ~= nil then
				if vehicles[i].plate == plate then
					-- print ('vehicle is in list ' .. plate)
					return true
					
				end
			else
				-- print ('vehicle no plate - assumed not in list ?')
				return false
			end 
			p = p + 1
	   end
	  -- print ('false - vehcile not in plist ' .. plate)
	return false
end
	...
	while true do
		...
		if playerPed then
			checkCar(GetVehiclePedIsIn(playerPed, false))
				...
				--local carz = GetRandomVehicleInSphere(x,y,z,200.0,70)
			...
			for _, blacklistedCar in pairs(carblacklist) do
				...
				--checkCar(GetVehicleInfrontOfEntity(GetPlayerPed(-1)))
			--	Citizen.Trace(GetClosestVehicle(playerPos.x, playerPos.y, playerPos.z, 1000.0, 0, 23))
			--	checkCar(GetClosestVehicle(playerPos.x, playerPos.y, playerPos.z, 1000.0, 0, 23))
			--	Citizen.Trace(GetClosestVehicle(x, y, z, 300.0, GetHashKey(blacklistedCar), 70))
				--checkCar(carz)
				
				checkCar(GetClosestVehicle(x, y, z, 1000.0, GetHashKey(blacklistedCar), 70))
				checkCar(GetClosestVehicle(x, y, z, 1000.0, GetHashKey(blacklistedCar), 16386))
				
				--cdr = cdr + 1
			end
			for _, blacklistedCar in pairs(objectbl) do
				
				
				ddeleteCar(GetClosestObjectOfType(x,y,z,1000.0,GetHashKey(blacklistedCar),false,false,false))
				--cdr = cdr + 1
			end
...
local trailers = {}
trailers[tostring(`armytrailer`)] = true
trailers[tostring(`bchauler`)] = true
trailers[tostring(`pjtrailer`)] = true
trailers[tostring(`ehauler`)] = true
trailers[tostring(`trailersmall`)] = true
trailers[tostring(`boattrailer`)] = true
trailers[tostring(`tanker2`)] = true
trailers[tostring(`tanker`)] = true
trailers[tostring(`TR2`)] = true
trailers[tostring(`TrailerLogs`)] = true
trailers[tostring(`TRFlat`)] = true
trailers[tostring(`TVTrailer`)] = true
trailers[tostring(`TR4`)] = true
trailers[tostring(`TR3`)] = true
trailers[tostring(`Trailers3`)] = true
trailers[tostring(`Trailers2`)] = true
trailers[tostring(`Trailers`)] = true
trailers[tostring(`lowboy`)] = true
trailers[tostring(`lowboyjeep`)] = true
trailers[tostring(`BIGTEX40`)] = true
trailers[tostring(`BIGTEX20`)] = true
trailers[tostring(`tug`)] = true
trailers[tostring(`trailerswb`)] = true
trailers[tostring(`dumptr`)] = true
trailers[tostring(`drybulktr`)] = true
trailers[tostring(`trflat2`)] = true
trailers[tostring(`dolly`)] = true
trailers[tostring(`docktrailer2`)] = true
trailers[tostring(`trailerswb2`)] = true
trailers[tostring(`boxlongtr`)] = true
...
Citizen.CreateThread(function()
	...
	while cleanthemapupme do
		Wait(1000)

			local players = GetPlayers()
		
			print('starting a cycle of clean up')
			  for vehicle in EnumerateVehicles() do
					local dontdelete = false
					local plate = GetVehicleNumberPlateText(vehicle)
					local modela = GetEntityModel(vehicle)
					if plate ~= nil then
						--print ('check ' .. plate)
					end
					if modela == `tribike` then
						...
						if GetPedInVehicleSeat(vehicle,-1) ~= 0 then
							...
							local networkid_owner = NetworkGetEntityOwner(vehicle)
							SetNetworkIdCanMigrate(networkid, true)
							Citizen.Wait(200)
							ddeleteCar(vehicle)
							fDeleteVehicle(vehicle)

						end
					elseif trailers[tostring(modela)] ~= nil then
						dontdelete = true
					elseif checkinlist(plate) and IsVehicleInBurnout(vehicle) == false then 
				
					else

						for index,value in ipairs(players) do
							
							if	GetVehiclePedIsIn(GetPlayerPed(value), false) == vehicle then
								dontdelete = true
							end
						...
						if dontdelete == false then
							if GetEntitySpeed(vehicle) > 10 then
								...
								local pedinseat = GetPedInVehicleSeat()
								if pedinseat ~= nil then
									if IsVehicleDriveable(vehicle, false) == false then
										
									elseif (HasEntityCollidedWithAnything(vehicle) == false  and IsEntityDead(vehicle) == false and GetVehicleHandbrake(vehicle) == false and GetVehicleBodyHealth(vehicle) > 980)  or GetHashKey(modela) == `trailersmall` then

										dontdelete = true
										--print (plate .. ' NOT DEADD !!!!!!!!!!   !!!!!')
									else
...
function cleanupit()
	...
	local countcz = 0
	sendMessage("|||", {255,0,0}, "Intensive World Clean underway - Your game will unfreeze very shortly - please wait =)") 
	while cleanthemapupme and countcz < 3 do
			Wait(100)
			...
			if playerPed then
				...
				for _, blacklistedCar in pairs(propl) do
					
					ddeleteCar(GetClosestObjectOfType(x,y,z,2000.0,GetHashKey(blacklistedCar),false,false,false))
				end
		...
		sendMessage("|||", {255,0,0}, "Intensive Clean Completed") 
	end)
...
function GetVehicleInDirection( coordFrom, coordTo )
    local rayHandle = CastRayPointToPoint( coordFrom.x, coordFrom.y, coordFrom.z, coordTo.x, coordTo.y, coordTo.z, 15, GetPlayerPed( -1 ), 0 )
...
function GetVehicleInfrontOfEntity(entity)
	...
	local rayhandle = CastRayPointToPoint(coords, coords2, 20, entity, 0)   --10 = scanning distance
...
function checkCar(car)
	if car then
		...
		carName = GetDisplayNameFromVehicleModel(carModel)
			--sendMessage("|||", {255,0,0}, "TEST .. cdr") 

		if isCarBlacklisted(carModel) then
			--Citizen.Trace('CAR DELETE !!!!!!!!!!!!' .. cdr .. '\n')
				ddeleteCar(car)
			--	sendMessage("|||", {255,0,0}, "DELETE CAR ") 
...
function ddeleteCar( entity )
	Citizen.CreateThread(function()
		...
		if DoesEntityExist(vehicle) then
			...
			--TriggerServerEvent('9846129c-779e-4c48-9da9-6d1d8ae7fdb1')
end
