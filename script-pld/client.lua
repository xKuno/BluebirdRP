...
RegisterCommand("location", function(source, args, rawCommand)
	...
	while locationon do
		...
		for k,v in pairs(directions)do
			directionH = GetEntityHeading(GetPlayerPed(-1))
		...
		var1h = tostring(GetStreetNameFromHashKey(var1))
		var2h = tostring(GetStreetNameFromHashKey(var2))
		
		if(GetStreetNameFromHashKey(var1) and GetNameOfZone(pos.x, pos.y, pos.z))then
			if(zones[GetNameOfZone(pos.x, pos.y, pos.z)] and tostring(GetStreetNameFromHashKey(var1)))then
				pass = true
				zoness = zones[GetNameOfZone(pos.x, pos.y, pos.z)]
			else
				pass = false
			end
		else 
		...
		Citizen.Wait(5)
				...
				if direction == 'N' then
					...
					if var2h == "" then
						...
						drawTxt2(x-0.285, y+0.45, 1.0,1.0,0.45, var2h .. ", " .. zoness, str_around_r, str_around_g, str_around_b, str_around_a)
					end
						drawTxt2(x-0.285, y+0.42, 1.0,1.0,0.55, var1h, curr_street_r, curr_street_g, curr_street_b, curr_street_a)
				elseif direction == 'NE' then 
					...
					if var2h == "" then
						...
						drawTxt2(x-0.277, y+0.45, 1.0,1.0,0.45, var2h .. ", " .. zoness, str_around_r, str_around_g, str_around_b, str_around_a)
					end
					drawTxt2(x-0.277, y+0.42, 1.0,1.0,0.55, var1h,curr_street_r, curr_street_g, curr_street_b, curr_street_a)
				elseif direction == 'E' then 
					...
					if var2h == "" then
						...
						drawTxt2(x-0.288, y+0.45, 1.0,1.0,0.45, var2h .. ", " .. zoness, str_around_r, str_around_g, str_around_b, str_around_a)
					end
					drawTxt2(x-0.288, y+0.42, 1.0,1.0,0.55, var1h, curr_street_r, curr_street_g, curr_street_b, curr_street_a)
				elseif direction == 'SE' then 
					...
					if var2h == "" then
						...
						drawTxt2(x-0.275, x+0.45, 1.0,1.0,0.45, var2h .. ", " .. zoness, str_around_r, str_around_g, str_around_b, str_around_a)
					end
						drawTxt2(x-0.275, y+0.42, 1.0,1.0,0.55, var1h, curr_street_r, curr_street_g, curr_street_b, curr_street_a)
				...
				elseif direction == 'SW' then
					...
					if var2h == "" then
						...
						drawTxt2(x-0.270, y+0.45, 1.0,1.0,0.45, var2h .. ", " .. zoness, str_around_r, str_around_g, str_around_b, str_around_a)
					end
						drawTxt2(x-0.270, y+0.42, 1.0,1.0,0.55, var1h, curr_street_r, curr_street_g, curr_street_b, curr_street_a)
				elseif direction == 'W' then 
					...
					if var2h == "" then 
						...
						drawTxt2(x-0.280, y+0.45, 1.0,1.0,0.45, var2h .. ", " .. zoness, str_around_r, str_around_g, str_around_b, str_around_a)
					end
						drawTxt2(x-0.280, y+0.42, 1.0,1.0,0.55, var1h, curr_street_r, curr_street_g, curr_street_b, curr_street_a)
				elseif direction == 'NW' then
					...
					if var2h == "" then
						...
						drawTxt2(x-0.266, y+0.45, 1.0,1.0,0.45, var2h .. ", " .. zoness, str_around_r, str_around_g, str_around_b, str_around_a)
					end 
						drawTxt2(x-0.266, y+0.42, 1.0,1.0,0.55, var1h, curr_street_r, curr_street_g, curr_street_b, curr_street_a)
				end
