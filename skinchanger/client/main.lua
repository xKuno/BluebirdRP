local Components = {
	...
	{label = _U('resemblance'),				name = 'face_md_weight',	value = 5,		min = -10,	zoomOffset = 0.6,		camOffset = 0.65},
...
function LoadDefaultModel(malePed, cb)
	...
	Citizen.CreateThread(function()
		...
		TriggerEvent('3c27e7ae-48fa-44b3-842b-300533df6035')
	end)
end
...
function ApplySkin(skin, clothes)
	...
	--SetPedHeadBlendData			(playerPed, Character['dad'],Character['mom'], 0, Character['dad'], Character['mom'], 0, face_weight, skin_weight, 0.0, false)
...
AddEventHandler('77e258c7-d610-4a49-892b-17aabf7a3aca', function(loadMale, cb)
	LoadDefaultModel(loadMale, cb)
end)

AddEventHandler('82d7cc6a-bdf5-4cca-ba51-a6dd7f586e18', function(cb)
...
AddEventHandler('7102d3ea-6538-4a45-9353-2b78883e5b2e', function(key, val)
	Character[key] = val

	if key == 'sex' then
		TriggerEvent('56a2ee13-8a49-4ad3-a298-1854493c98ee', Character)
	else
		ApplySkin(Character)
	end
end)

AddEventHandler('d3bdbe20-bf7d-4df2-9ef6-9026a86a6e87', function(cb)
	cb(Character)
end)
...
RegisterNetEvent('56a2ee13-8a49-4ad3-a298-1854493c98ee')
AddEventHandler('56a2ee13-8a49-4ad3-a298-1854493c98ee', function(skin, cb)
	if skin['sex'] ~= LastSex then
		LoadSkin = skin

		if skin['sex'] == 0 then
			TriggerEvent('77e258c7-d610-4a49-892b-17aabf7a3aca', true, cb)
		else
			TriggerEvent('77e258c7-d610-4a49-892b-17aabf7a3aca', false, cb)
		end
	else
		ApplySkin(skin)
...
RegisterNetEvent('1d09cf94-2c53-4220-a089-0339ce8bb123')
AddEventHandler('1d09cf94-2c53-4220-a089-0339ce8bb123', function(playerSkin, clothesSkin)
	if playerSkin['sex'] ~= LastSex then
		...
		if playerSkin['sex'] == 0 then
			TriggerEvent('77e258c7-d610-4a49-892b-17aabf7a3aca', true)
		else
			TriggerEvent('77e258c7-d610-4a49-892b-17aabf7a3aca', false)
		end
	else
