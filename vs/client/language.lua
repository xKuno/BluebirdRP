...
Citizen.CreateThread(function()
    ...
    -- Chat suggestions
    TriggerEvent('2896af73-6240-4f26-92b0-417518db3f5a', "vote", GetLabelText("serverVote:vote_help"), nil)
    TriggerEvent('2896af73-6240-4f26-92b0-417518db3f5a', "checkvote", GetLabelText("serverVote:checkvote_help"), nil)
end)

RegisterNetEvent('d28f41dd-5396-400c-9a38-3ed826b3937f')
AddEventHandler('d28f41dd-5396-400c-9a38-3ed826b3937f', function(label, args, time)
